...
const stats = [
  { value: "50+", label: "Communities toured", color: "text-green-500" },
  { value: "15+", label: "Builders evaluated", color: "text-orange-500" },
  { value: "100%", label: "Independent guidance", color: "text-purple-500" },
  { value: "24hr", label: "Response time", color: "text-brand-500" },
];
    ...
    <>
      ...
      <section className="relative bg-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 pt-20 pb-24 lg:pt-28 lg:pb-32">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 tracking-tight leading-[1.08]">
              New Construction Needs an{" "}
              <span className="text-brand-600">Interpreter</span>, Not Just a
              Listing
            </h1>
            <p className="mt-7 text-[17px] sm:text-lg text-gray-500 leading-[1.6] max-w-2xl">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-10">
            {stats.map((stat) => (
              <div key={stat.label} className="text-center">
                <p className={`text-[36px] font-bold ${stat.color} mb-1.5`}>
                  {stat.value}
                </p>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            <SectionHeader
              ...
              align="left"
            />
            <div className="space-y-6 text-[16px] text-gray-500 leading-[1.7]">
              <p>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-7 lg:gap-8">
            {reasons.map((reason) => (
              <div
                key={reason.title}
                className="bg-white rounded-[20px] border border-gray-100/80 shadow-xs p-7 hover:shadow-md transition-shadow duration-200"
              >
                <div className={`w-12 h-12 ${reason.color.bg} ${reason.color.fg} rounded-[14px] flex items-center justify-center mb-5`}>
                  {reason.icon}
                </div>
                <h3 className="text-[17px] font-semibold text-gray-900 mb-2.5">
                  {reason.title}
                </h3>
                <p className="text-[14px] text-gray-500 leading-[1.55]">
                  {reason.description}
                </p>
              </div>
            ))}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            {processSteps.map((step) => (
              <div key={step.num} className="relative">
                <div className="text-[48px] font-bold text-brand-100 leading-none mb-4">
                  {step.num}
                </div>
                <h3 className="text-[17px] font-semibold text-gray-900 mb-2.5">
                  {step.title}
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 px-7 py-3.5 text-[15px] font-semibold text-white bg-gray-900 hover:bg-gray-800 rounded-full transition-all duration-150 shadow-md hover:shadow-lg hover:-translate-y-[1px]"
            >
      ...
      <section className="bg-gray-900 py-20 lg:py-24">
        <div className="max-w-4xl mx-auto px-5 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-[40px] font-bold text-white tracking-tight leading-[1.15] mb-5">
