      ...
      <section className="relative bg-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 pt-20 pb-24 lg:pt-28 lg:pb-32">
          ...
          <div className="grid lg:grid-cols-5 gap-10 lg:gap-14 items-start">
            {/* Form */}
            <div className="lg:col-span-3 bg-white border border-gray-100 rounded-[20px] shadow-sm p-7 sm:p-9">
            ...
            <div className="lg:col-span-2 space-y-6">
              {/* What to expect */}
              <div className="bg-gray-50/80 rounded-[20px] p-7">
                <h3 className="text-[12px] font-semibold text-gray-900 uppercase tracking-widest mb-5">
                  What You&apos;ll Get
                </h3>
                <ul className="space-y-6">
                  {expectations.map((item) => (
                    <li key={item.title} className="flex gap-4">
                      <div className={`shrink-0 w-10 h-10 ${item.color.bg} ${item.color.fg} rounded-[10px] flex items-center justify-center`}>
                        {item.icon}
                      </div>
                      <div>
                        ...
                        <p className="text-[13px] text-gray-500 leading-[1.55] mt-0.5">
                          {item.description}
                        </p>
                      </div>
                    </li>
                ...
                <ol className="space-y-5">
                  {steps.map((step) => (
                    <li key={step.num} className="flex gap-4">
                      <div className="shrink-0 w-8 h-8 bg-brand-600 text-white text-[12px] font-bold rounded-full flex items-center justify-center">
                        {step.num}
                      </div>
                      <div>
                        <p className="text-[14px] font-medium text-gray-900">
              ...
              <div className="bg-gray-50/80 rounded-[20px] p-7">
                ...
                <div className="space-y-4 text-[14px]">
                  <a
                    ...
                    className="flex items-center gap-3 text-gray-600 hover:text-brand-600 transition-colors duration-150"
                  >
